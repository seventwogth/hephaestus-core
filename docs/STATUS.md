...
1. Добавить агент-архитектор, который формирует `PLAN.json` и REST API-контракт.
2. Добавить генерацию backend-модулей Go поверх шаблона.
3. Добавить генерацию frontend-страниц и API-клиента поверх шаблона.
4. Реализовать ограниченный цикл исправлений по `REVIEW.md`.
5. Подключить Telegram-бота как пользовательский интерфейс MVP.
