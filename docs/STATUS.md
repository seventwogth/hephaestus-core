...
2. Добавить daemon/job-runner слой на хост-машине, чтобы Telegram управлял очередью задач, статусами и повторными запусками без привязки к одному процессу polling-бота.
